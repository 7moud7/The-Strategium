# App artwork (generated with Higgsfield)

The app looks for these files in this folder (`WH40K/Images/App/`). Until they
exist here, the app falls back to the direct Higgsfield CDN links baked into
`App/thestrategium.html` (the `ART_OVERRIDES` map).

To make the artwork permanent, download each URL below, save it with the given
filename in this folder, commit, then delete the entries in `ART_OVERRIDES`:

| Filename | Used for | Download from |
|---|---|---|
| `menu-bg.jpg` | Main menu background (portrait) | https://d8j0ntlcm91z4.cloudfront.net/user_3FwF4EjNC4sIwygqgRcuB1zIZyi/hf_20260705_222218_f042586c-65b5-4cef-b80f-b4b845fa112a.png |
